...
#include "TileMap/TileMapParams.h"
#include "TileData/TileScheme.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(TileMapParams)

void FTileMapParams::GetSchemeSequence(TArray<ETileScheme>& OutSequence) const
{
