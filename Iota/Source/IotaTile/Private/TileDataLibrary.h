...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "LevelGeneration|TileBound")
	...
	static void GetTileSequence(const FTileGenParams& Parameters, TArray<ETileScheme>& Sequence);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "LevelGeneration|TilePlan")
